...
function Header() {
    ...
    return (
        <header id="header" className={`${isFixed ? 'fixed' : ''}`}>
            ...
            <div className="logo">
                <NavLink to="/">
                    <img src={`${isFixed ? logo : logoWhite}`} alt="fpt-health"
            ...
            <ul className="header-btn">
                {isLoggedIn ? (
                        ...
                        <li>
                            <div className="profile-btn">
                                ...
                                <div className="profile-action">
                                    <NavLink to="/appointment" className="book-btn">Booking</NavLink>
                                    <NavLink to="/dashboard" className="dashboard">Dashboard</NavLink>
                                    <a className="sign-out-btn" onClick={handleLogout}>Sign out</a>
                                </div>
                            </div>
                    ...
                    <>
                        <li>
                            <button className="sign-in-btn" onClick={toggleLoginVisibility}>Sign in</button>
                        </li>
                        <li>
                            <NavLink to="/appointment" className="booking-btn">Book Now</NavLink>
                        </li>
                    </>
                )}
            </ul>
                    ...
                    <div className={`login-form ${isRegisterVisible || isResetPassVisible ? 'hide' : 'show'}`}>
                        ...
                        <div className="social-login">
                            <div className="social-btn gg">
                                <span>Google</span>
                                <a><img width="25" height="25" src="https://img.icons8.com/fluency/48/google-logo.png"
                                        alt="google-logo"/></a>
                            </div>
                            ...
                            <div className="social-btn fb">
                                <span>Facebook</span>
                                <a><img width="25" height="25" src="https://img.icons8.com/fluency/48/facebook-new.png"
                                        alt="facebook-new"/></a>
                            </div>
                        ...
                        <form className="login-form-container" onSubmit={handleLogin}>
                            <div className="input-list">
                                ...
                                <a className="forgot-pass" onClick={toggleResetPassVisibility}>Forgot your password?</a>
                                <button type="submit" disabled={!isFormValid}>Sign in</button>
                                <p className="form-content">Don't have an account? <a className="sign-up"
                                                                                      onClick={toggleRegisterVisibility}>Sign
                                    up</a></p>
                            </div>
                        </form>
                    </div>
                            ...
                            <div className="input-list">
                                ...
                                <div className={`input-area ${repeatPassword ? 'has-value' : ''}`}>
                                    <input
                                        ...
                                        onChange={(e) => handleInputChange(e, setRepeatPassword, validateRepeatPassword)}
                                    />
                                    <label htmlFor="repeat-password">Confirm Password</label>
                                    {errors.repeatPassword &&
                                        <span className="error-mess">{errors.repeatPassword}</span>}
                                </div>
                                ...
                                <p className="form-content">Already have an account? <a className="sign-in"
                                                                                        onClick={toggleRegisterVisibility}>Sign
                                    in</a></p>
                            </div>
                        </form>
                            ...
                            <div className="input-list">
                                <div className={`input-area ${email ? 'has-value' : ''}`}>
                                    ...
                                    <button type="button" className="get-code" onClick={handleGetCode}
                                            disabled={cooldown > 0 || isLoading || !email || errors.email}>
                                        {isLoading ? (<div
            ...
            {isOpenMenu && (
                <div className="menu-container">
                    <ul className="menu-links">
                        <li>
                            <NavLink to="/" onClick={toggleMenuVisibility}>Home</NavLink>
                        </li>
                        <li>
                        ...
                        {isLoggedIn ? (
                            <>
                                ...
                                <li>
                                    <button className="menu-sign-out" onClick={() => {
                                        handleLogout();
                                        toggleMenuVisibility();
                                    }}>Sign out
                                    </button>
