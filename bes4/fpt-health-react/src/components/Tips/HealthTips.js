    ...
    return (
        <main className="health-tips-container">
            ...
            <section className="health-tips-banner">
                <img alt="health-tips-banner" src="https://media.istockphoto.com/id/519368348/vector/fitness-and-sport.jpg?s=612x612&w=0&k=20&c=LdZAQ0BJ5aLMT_CAmgLRnoDs2U0x8l_CpJzk9vsiANI=" />
            </section>
            ...
            <footer>
                <div className="footer-container-top">
                    <div className="footer-logo">
                        <img src="https://via.placeholder.com/140x40?text=FPT+Health+Logo" alt="fpt-health" style={{width: '140px', height: '40px'}} />
                    </div>
                    ...
                    <div className="footer-content">
                        ...
                        <div className="footer-contact">
                            <div className="footer-contact-item">
                                <img src="https://img.icons8.com/ios-filled/50/FFFFFF/marker.png" alt="marker" />
